...
public class ComplianceApiTests {
    ...
    public void testWithdrawAllowed(){
        var account = new BankAccount("44734907-38a8-4f29-a145-107f717f9448", 123456, 123, 100);
    ...
    public void testWithdrawNotAllowed(){
        var account = new BankAccount("38cec9a0-6bd8-49c6-8177-a57c06ffd1bb", 123456, 123, 100);
    ...
    public void testWithdrawException(){
        var account = new BankAccount("6ed096c5-5760-4141-b75d-fa778a70db0d", 123456, 123, 100);
